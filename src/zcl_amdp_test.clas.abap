...
"! </ol>
"!
"! For more information, see { @link https://help.sap.com/doc/abapdocu_cp_index_htm/CLOUD/en-US/index.htm }
...
CLASS zcl_amdp_test DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS:
      ...
      "! <p class="shorttext synchronized"> Method converts currency to EUR using AMDP</p>
      convert_currency
        IMPORTING
...
CLASS ZCL_AMDP_TEST IMPLEMENTATION.
  ...
  METHOD get_flights BY DATABASE PROCEDURE
    ...
    USING
      /dmo/flight
      /dmo/carrier
      ZCL_AMDP_TEST=>convert_currency.
    ...
    call "ZCL_AMDP_TEST=>CONVERT_CURRENCY"( :flights, result );
